...
export default function ManageProducts() {
  ...
  return (
    <div className="p-4 bg-gray-50 dark:bg-gray-900">
      <h2 className="text-2xl font-bold mb-4 text-gray-800 dark:text-white">Manage Products</h2>
        ...
        <table className="min-w-full">
          ...
          <tbody className="text-gray-600 dark:text-gray-200">
            {products.length > 0 ? (
              ...
              <tr>
                <td colSpan="5" className="py-3 px-6 text-center">No products found.</td>
              </tr>
            )}
          </tbody>
        </table>
